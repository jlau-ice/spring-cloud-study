package com.ice.item.service.impl;
...
import com.ice.item.mapper.ItemMapper;
import com.ice.item.service.IItemService;
...
public class ItemServiceImpl extends ServiceImpl<ItemMapper, Item> implements IItemService {
    ...
    public void deductStock(List<OrderDetailDTO> items) {
        String sqlStatement = "com.ice.item.mapper.ItemMapper.updateStock";
        boolean r = false;
        try {
